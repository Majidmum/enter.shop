    ...
    <div className="container mx-auto px-4 py-6 pb-20 md:pb-6">
      ...
      <div className="relative rounded-2xl overflow-hidden mt-4 mb-6 min-h-36 bg-secondary">
        ...
        <div className="relative z-10 p-6">
          ...
          <p className="text-white/70 mt-1">{category.productCount} products available</p>
        </div>
      </div>
      ...
      <div className="flex gap-6">
        ...
        <aside className="hidden md:flex flex-col w-52 shrink-0">
          <div className="rounded-xl bg-card border border-border p-4 sticky top-24">
            ...
            <p className="font-semibold text-sm mb-2">Price (TJS)</p>
        ...
        <div className="flex-1 min-w-0">
          ...
          {paginated.length > 0 ? (
            ...
            <p className="text-muted-foreground py-16 text-center">No products in this category with the selected filters.</p>
          )}
